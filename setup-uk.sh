...
User=kali
Group=kali
ExecStart=/usr/bin/autossh -M 11166 -N -f -o "PubkeyAuthentication=yes" -o "PasswordAuthentication=no" -o "StrictHostKeyChecking no" -i /home/kali/.ssh/id_ed25519 -R 6667:localhost:22 kali@159.65.62.92
RemainAfterExit=yes
[Install]
